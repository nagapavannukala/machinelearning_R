...
gbmFit <- gbm(
  ...
  data              = BSDF.dev[,c(-1)],# -1 to remove Cust ID
...
#install.packages( "C:/Users/nagapavan/Desktop/great lakes/R/classroom/ModelPerformance.zip",repos = NULL)
...
ModelPerformance::concordance(BSDF.holdout,"Target","predict.score")
